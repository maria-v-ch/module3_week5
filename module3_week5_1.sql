...
-- Проверка вставки данных в таблицу order_details
...
RETURNS TABLE (
	category VARCHAR,
	total_sales_per_category_per_period NUMERIC
)
AS $$
BEGIN
    RETURN QUERY
    ...
    SELECT cte.category, SUM(category_sales_per_date) AS total_sales_per_category_per_period
    FROM cte
